...
class ContinuousA2C(tf.keras.Model) :
    def __init__(self, action_size):
        ...
        self.actor_sigma = Dense(action_size, activation='softplus', kernel_initializer=RandomUniform(-1e-3, 1e-3))
...
class ContinuousA2CAgent :
    def __init__(self, action_size, max_action):
        ...
        # 정책신경망과 가치신경망 생성
        self.model = ContinuousA2C(action_size)
        self.model.load_weights(os.path.join(BASEDIR, "save_model", "model_v2"))
